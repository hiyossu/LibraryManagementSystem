...
public class BookFormCard {
    ...
    private final Color gold, red, cardColor, divColor, grayText, textColor;

    public BookFormCard(FormContext ctx, UIFactory ui, Color gold, Color red,
                        Color cardColor, Color divColor, Color grayText, Color textColor) {
        this.ctx = ctx; this.ui = ui; this.gold = gold; this.red = red;
    ...
    public JPanel build(Runnable onAdd, Runnable onClear, Runnable onDash) {
        JPanel card = new JPanel(new GridBagLayout()) {
            protected void paintComponent(Graphics g) {
                super.paintComponent(g); g.setColor(gold); g.fillRect(0, 0, getWidth(), 3);
            }
        };
        ...
        fc.gridy = 4; fc.gridx = 0; fc.gridwidth = 4; fc.insets = new Insets(22, 0, 0, 0);
